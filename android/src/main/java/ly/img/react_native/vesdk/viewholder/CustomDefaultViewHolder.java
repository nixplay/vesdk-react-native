...
public class CustomDefaultViewHolder extends DataSourceListAdapter.DataSourceViewHolder<CustomToolItem, CustomDefaultViewHolder.ThumbnailResult> implements View.OnClickListener {
    ...
    public CustomDefaultViewHolder(@NonNull View v) {
        super(v);
    ...
    @Override
    protected void bindData(CustomToolItem abstractItem) {
    ...
    @Override
    protected void bindData(CustomToolItem data, ThumbnailResult thumbnailResult) {
