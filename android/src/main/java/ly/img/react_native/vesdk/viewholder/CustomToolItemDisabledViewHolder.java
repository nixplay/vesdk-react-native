...
public class CustomToolItemDisabledViewHolder extends DataSourceListAdapter.DataSourceViewHolder<CustomToolItemDisabled, CustomToolItemDisabledViewHolder.ThumbnailResult> implements View.OnClickListener {
    ...
    public CustomToolItemDisabledViewHolder(@NonNull View v) {
        super(v);
...
//        this.dispatchOnItemClick();
    ...
    @Override
    protected void bindData(CustomToolItemDisabled abstractItem) {
    ...
    @Override
    protected void bindData(CustomToolItemDisabled data, CustomToolItemDisabledViewHolder.ThumbnailResult thumbnailResult) {
