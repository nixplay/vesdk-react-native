...
public class CustomAdjustOptionViewHolder extends DataSourceListAdapter.DataSourceViewHolder<AbstractItem, CustomAdjustOptionViewHolder.ThumbnailResult> implements View.OnClickListener {
...
//        this.dispatchOnItemClick();
    ...
    @Override
    protected void bindData(AbstractItem data, CustomAdjustOptionViewHolder.ThumbnailResult thumbnailResult) {
